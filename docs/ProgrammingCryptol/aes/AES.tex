...
\begin{code}
  ...
  aesEncrypt (pt, key) = stateToMsg (AESFinalRound (kFinal, last(rounds)))
...
\begin{code}
  ...
  aesDecrypt (ct, key) = stateToMsg (AESFinalInvRound (kFinal, last(rounds)))
    where
